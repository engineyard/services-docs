...
This page provides you with the information you need to register services.  After you have registered a service, you can use the web UI to activate the service in "test" for the Engine Yard Cloud account that you created in Step 1.
